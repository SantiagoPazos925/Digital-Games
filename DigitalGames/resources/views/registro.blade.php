    ...
    <div class="contenedorForm col-10 offset-1">
      ...
      <div class="contenedor-fluid">
        <form class="login" action="registro.php" method="post" enctype="multipart/form-data" >
          ...
          <label for="">Nombre Completo: <span class="error" ><?php  /* $errores['Nombre']??'' */ ?></span> <br><input type="text" name="nombreCompleto" value="<?php /* /echo (($_POST['nombreCompleto'])??'') */ ?>"> </label>
          <br><br>
          <label for="">Usuario: <span class="error" ><?php  /* $errores['Usuario']??'' */ ?></span> <br><input type="text" name="nick" value="<?php /*  echo (($_POST['nick'])??'') */ ?>"></label>
          <br><br>
          <label for="">Email: <span class="error" ><?php  /* $errores['Email']??'' */ ?></span><br><input type="email" name="email" value="<?php  /* echo (($_POST['email'])??'') */ ?>"></label>
